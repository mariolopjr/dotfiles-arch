...
sudo rpm-ostree install akmod-nvidia xorg-x11-drv-nvidia steam virt-manager virt-viewer virt-top libvirt zsh vagrant neovim tmux bat git-delta fzf ripgrep fd-find mozilla-openh264
